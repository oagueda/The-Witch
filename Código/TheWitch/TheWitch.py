...
class Aplicacion:
    def __init__(self):
        ...
        root.button2 = ttk.Button(root, text="Generar Grupos", command=lambda:[mainGrupos()])
        root.button2.grid(column=2,row=1,sticky=EW,padx=15,pady=15)
        root.button3 = ttk.Button(root, text="Generar Carpetas", command=lambda:[mainCarpetas()])
        root.button3.grid(column=2,row=2,sticky=EW,padx=15,pady=15)
